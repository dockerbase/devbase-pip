...
run:
	docker run -it --rm --name dockerbase-devbase-pip $(NAME):$(VERSION)
...
version:
	...
	docker run -it --rm $(NAME):$(VERSION) sh -c " python --version ; pip --version " | tee -a COMPONENTS
	dos2unix COMPONENTS
